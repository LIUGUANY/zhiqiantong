...
function showLoginInfo() {
	...
	if(isNotNull(entity)){
		$(".loginLi").hide();
		$(".login-ucenter").removeClass('undis');
		$("#loginMsgOn").show();
		$("#loginMsgOFF").hide();
        ...
        if(entity.avatar && isNotEmpty(entity.avatar)){
            ...
            $("#cusImg").attr("src","/static/edu/images/uc-imgage-default.png");
            $("#userImgId").attr("src","/static/edu/images/uc-imgage-default.png");
        }
	}else{
 			...
 			$.ajax({
 				...
 				success: function (result){
 					if(result.message=="success"){
						$("#f1House").html("");
						$("#f1House").append('<em class="icon24 vam sx-sc"></em><a href="javascript:void(0)" class="fsize14 c-666 vam">已收藏</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;');
